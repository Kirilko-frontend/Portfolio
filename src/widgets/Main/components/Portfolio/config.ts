import preview1 from '/projects-videos/project-1.mp4';
import preview2 from '/projects-videos/project-2.mp4';
import preview3 from '/projects-videos/project-3.mp4';
